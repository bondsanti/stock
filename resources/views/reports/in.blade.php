        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">รีพอร์ต IN ทั้งหมด <button id="export-btn" class="btn btn-sm bg-gradient-primary"><i class="fa fa-file-excel"></i>
...
@push('script')
    ...
    <script>
        ...
        XLSX.writeFile(workbook, 'report-in.xlsx');
        }
