        ...
        <div class="container-fluid">
                            ...
                            <div class="card-body">
                                <div class="form-group row justify-content-center">
                                    ...
                                    <div class="col-sm-2 my-auto">
                                        <input class="form-control datepicker" name="start_date" id="start_date" type="text" value=""
                                            placeholder="วันที่เริ่มต้น" autocomplete="off">
                                    </div>

                                    <label for="" class="col-form-label text-right ">ถึง</label>
                                    <div class="col-sm-2 my-auto">
                                        <input class="form-control datepicker" name="end_date" id="end_date" type="text" value=""
                                ...
                                <div class="box-footer text-center">
                                    ...
                                    <a href="" type="button" class="btn btn-danger">เคลียร์</a>
                                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">รีพอร์ต OUT ทั้งหมด <button id="export-btn" class="btn btn-sm bg-gradient-primary"><i class="fa fa-file-excel"></i>
                            ...
                            <table id="my-table" class="table table-bordered table-striped table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">{{ number_format($item['project']->booking+$item['project']->contract,0)}}</td>
                                        <td class="text-right">{{ number_format($item['project']->slabooking+$item['project']->slacontract,0)}}</td>
                                        <td class="text-right">{{ number_format(($divSla)*100,0) }}%</td>
                                        <td class="text-right">{{ number_format($item['project']->slabooking,0)}}</td>
                                        <td class="text-right">{{ number_format($item['project']->slacontract,0)}}</td>
                                        <td class="text-right">{{ number_format($item['project']->deposit,0)}}</td>
                                        <td class="text-right">{{ number_format($item['project']->booking_price,0)}}</td>
                                        <td class="text-right">{{ number_format($item['project']->contract_price,0)}}</td>
                                    ...
                                    <tr class="text-right">
                                        ...
                                        @if ($sumDivSla !== 0)
                                        <td>{{ number_format((($sumSlabooking + $sumSlacontract) / $sumDivSla) * 100, 0) }}%</td>
                                        @else
                                            <td>0%</td>
                                        @endif
...
@push('script')
    ...
    <script>
        ...
        XLSX.writeFile(workbook, 'report-out.xlsx');
        }
