        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">รีพอร์ตทั้งหมด
                                <button id="export-btn" class="btn btn-sm bg-gradient-primary"><i
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">{{ number_format($item['project']->available, 0) }}
                                            </td>
                                            <td class="text-right">
                                                {{ number_format($item['project']->booking + $item['project']->contract, 0) }}
                                            </td>
                                            <td class="text-right"> {{ number_format($item['project']->notready, 0) }}
                                            </td>
                                            <td class="text-right">
                                            ...
                                            <td class="text-right">
                                                {{ number_format($item['project']->contract_price, 0) }}
                                            </td>
                            ...
                            <table id="" class="table table-bordered table-striped table-sm">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-left" colspan="2">โอนแล้ว</td>
                                        <td class="text-right">
                                            {{ number_format($pro_in_mortgage + $pro_out_mortgage, 0) }}
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            {{ number_format($pro_in_contract + $pro_out_contract, 0) }}
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" class="text-left">รวมทั้งหมด</td>
                                        <td class="text-right">
