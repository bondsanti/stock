...
@endphp --}}
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">ทีมทั้งหมด <button type="button" class="btn bg-gradient-primary" id="Create">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="inputEmail3"
                                            class="col-sm-4 col-form-label text-right">ชื่อทีม</label>
                                        <div class="col-sm-6">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="team_name_edit" name="team_name_edit"
                                                placeholder="" autocomplete="off">
    ...
    <script>
        $(document).ready(function() {
                    ...
                    success: function(data) {
                        ...
                        if (data.success = true) {
                            ...
                            if ($.isEmptyObject(data.error)) {
                                ...
                                // table.draw();
                                setTimeout("location.href = '{{ route('team') }}';",
                                    1500);
                                ...
                                $('#createForm').trigger("reset");
                                $('.name_err').text(data.error.team_name);
                                Swal.fire({
                                    position: 'top-center',
                                    icon: 'error',
            ...
            $('body').on('click', '.delete-item', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "DELETE",
                            url: 'api/team/destroy/' + id + '/' + user_id,
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') // รับ CSRF token จาก meta tag ในหน้า HTML
                            },
                            success: function(data) {
            ...
            $('body').on('click', '.edit-item', function() {
                ...
                $.get('api/team/edit/' + id, function(data) {
                    $('#id_edit').val(data.id);
                    ...
                    success: function(data) {
                        ...
                        if (data.success = true) {
                            ...
                            if ($.isEmptyObject(data.error)) {
                                ...
                                $('.name_edit_err').text(data.error.team_name);
                                $('#modal-edit').trigger("reset");
