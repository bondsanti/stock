...
@endphp --}}
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">เครื่องใช้ไฟฟ้า ทั้งหมด
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">เครื่องใช้ไฟฟ้า ทั้งหมด</h3>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="inputEmail3"
                                            class="col-sm-4 col-form-label text-right">ชื่อเครื่องไฟฟ้า</label>
                                        <div class="col-sm-6">
    ...
    <script>
        $(document).ready(function() {
                    ...
                    success: function(data) {
                        ...
                        if (data.success = true) {
                            ...
                            if ($.isEmptyObject(data.error)) {
                                ...
                                // table.draw();
                                setTimeout("location.href = '{{ route('facilities') }}';",
                                    1500);
            ...
            $('body').on('click', '.delete-item', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "DELETE",
                            url: 'api/facilities/destroy/' + id + '/' + user_id,
                            ...
                            success: function(data) {
                                ...
                                setTimeout(
                                    "location.href = '{{ route('facilities') }}';",
                                    1500);
            ...
            $('body').on('click', '.edit-item', function() {
                ...
                $.get('api/facilities/edit/' + id, function(data) {
                    $('#id_edit').val(data.id);
